<%@ Page Title="" Language="C#" MasterPageFile="~/Web.Master" AutoEventWireup="true" CodeBehind="memberLogin.aspx.cs" Inherits="Assignment7.memberLogin" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Member Login - Puchong Airlines</title>
    <style>
        table {
            position: relative;
            left: 120px;
            ...
            <article class="col1">
                <asp:LoginView ID="LoginView1" runat="server">
                    <AnonymousTemplate> <%--if the user is not login (Anonymouse/Vistor)--%>
                        <asp:Login ID="Login1" runat="server" CreateUserText="Sign Up for a New Account at Puchong Airlines" CreateUserUrl="SignUp.aspx" OnLoggedIn="Login1_LoggedIn">
                            <LayoutTemplate>
                                <table style="border-collapse: collapse;">
                                    <tr>
                                        <td>
                                            <table>
                                                <tr>
                                                    <th style="text-align: center" colspan="2">Member Login</th>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="text-align: left" colspan="2">
                                                        <asp:HyperLink ID="CreateUserLink" runat="server" NavigateUrl="signUp.aspx">Sign Up for a New Account at Puchong Airlines</asp:HyperLink>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                    ...
                    <RoleGroups>
                        <asp:RoleGroup Roles="Member"> <%--the below content is available to view for the user that logged in role as "Member"--%>
                            <ContentTemplate> <%--display for user role "Member" that he/she is logged in --%>
                        ...
                        <asp:RoleGroup Roles="Admin"> <%--the below content is available to view for the user that logged in role as "Admin"--%>
                            <ContentTemplate> <%--display "Member" login control for user role "Admin" because he/she is logged in as "Admin"--%>
                                <asp:Login ID="Login1" runat="server" CreateUserText="Sign Up for a New Account at Puchong Airlines" CreateUserUrl="SignUp.aspx" OnLoggedIn="Login1_LoggedIn">
                                    <LayoutTemplate>
                                        <table style="border-collapse: collapse;">
                                            <tr>
